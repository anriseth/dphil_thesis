...
We consider a mathematical approach to this process that consists of
...
improvements in the control of demand for products would be advantageous
...
uncertainty in future events, and in estimates of model parameters, will
be described using random variables.

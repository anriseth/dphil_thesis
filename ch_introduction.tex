...
As we gain more knowledge of the system we wish to control and the
...
\begin{figure}[htbp]
  ...
  system and resulting decision impact.}\label{fig:decision_process}
\end{figure}

The mathematical decision making process, as we have defined it, is
general and can be applied to many decision problems. For a collection of
examples and arguments for a mathematical approach to decisions in
large organisations, see, for example \citet{keeney1976decisions} and
\citet{farmer2017uncertainty}.
We will use examples from the practice of revenue management to
motivate the theory and illustrate the algorithmic
approach to decision making that we present in this thesis.
...
% assimilation step.
Finally, \Cref{ch:objaccel} presents a new

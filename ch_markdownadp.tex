...
$\hat{S}_t$ and pricing process $\hat{\alpha}$ such that the $\hat{\alpha}_t$ that take values in a closed
...
\begin{figure}[htbp]
  ...
  \caption{This shows the distributions from \num{10000} samples of
    ...
    The distribution of $P(\alpha^B)-P(\alpha^C)$ appears to be bimodal.

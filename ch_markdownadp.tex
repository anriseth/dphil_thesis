...
Programming principle~\citep{bertsekas2005dynamic}. It states that
if $\alpha = {(\alpha_u)}_{u=0}^{T-1}$ is an optimal policy for the
problem over time points $u\in\{0,\dots,T-1\}$, then an optimal policy

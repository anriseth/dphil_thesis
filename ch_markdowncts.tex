...
by large retailers. For example, in the monopoly setting, this leads to
...
%   +U''(e)[D_\theta e]\Transpose{{[D_\theta e]}}.
% \end{align}
...
% In addition, we know that $\mbox{tr}(\Sigma(t,\theta)[D_\theta e]\Transpose{{[D_\theta e]}})\geq

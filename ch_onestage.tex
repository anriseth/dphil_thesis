...
\begin{align}
  q_1(x) &= e^{-2x_1}(1-e^{-10x_2/x_1}),\\
  q_2(x) &= 0.9e^{-1.8x_2}(1-e^{-4x_1/x_2})(1-e^{-40x_3/x_2}),\\
  q_3(x) &= 1.2e^{-2x_3}(1-e^{-15x_1/x_3}),
\end{align}
respectively.
The term $e^{-2x_1}$  models the impact of price
changes for product one, keeping product two's price constant.
The term $1-e^{-10x_2/x_1}$ models the proportion of product one's

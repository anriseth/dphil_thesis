...
The theory was inspired by work in finance for the of study financial
positions using
risk measures, see,
...
\begin{example}[Nonlinear expectations]
  ...
  connects this theory to robust optimization \citep{ben2009robust}.
...
\begin{example}[Pricing problem]
  Let us investigate the implication of

...
\begin{example}[Pricing problem]
  ...
  Note that the mean and standard deviation of the profit is
  \begin{equation}
    \mathbb{E}[f(x,y)]
...
\begin{example}[Comparison of Pareto front
  ...
  image of $F(x)$ are shown in \Cref{fig:pareto_local_disconnected} with
  a restricted domain $\mathcal{X}_{\textnormal{r}}=\{x\in {[0.4,4.6]}^2 \mid
  5e^{-x_1}+2e^{-\frac{1}{2}{(x_1-3)}^2} \leq x_2\}$.

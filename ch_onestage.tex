...
in 1713. He proposed a coin flipping game for which the
expected value is infinite, and the paradox arises from the
argument, at the time, that players should pay the expected value to
enter a game.
...
The use of paradoxes has been popular in order to motivate different
...
\citet{johnstone2013mean}.  The point is rather to note that the
paradoxes pick particular cases that highlight when particular
decision models fail. Instead of arguing for a universal model of how
...
\todo[inline]{Mention some of the controversies}

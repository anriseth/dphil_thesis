...
\Cref{sec:multi_multijump} shows how it is used to create the data for
...
local Pareto optimality. \Cref{ex:pareto_disconnected} show some issues that
...
in \Cref{sec:multi_pareto_front} have all been implemented.
...
decision of solving the problem. \Cref{lst:multijump} shows an example
